...
# 10. Páginas web dinâmicas com Javascript
...
Sempre que possível separe o código Javascript do HTML, evite usar as propriedades manipuladoras de eventos diretamente nos elementos HTML, prefira sempre atrelar eventos aos elementos HTML via DOM usando somente Javascript conforme mostrado nessa [seção](10.-paginas-web-dinamicas-com-javascript.md#manipulando-eventos-por-meio-do-dom-recomendado).
